...
# Pointer-input messages (pen / touch).  A window that handles these manages
# its own cursor, so Windows does NOT draw the pen hover cursor over it.
...
WM_POINTER_LAST = 0x0255

# Pen press-and-hold right-click gesture.
